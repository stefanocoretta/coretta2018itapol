...
```{r dlc-data}
dlc_data <- read_tsv("data-raw/datasets/ultrasound/dlc-ultrasound.tsv")
...
dlc_data <- dlc_data |> 
  pivot_longer(
    `X0 DLC_Tongue`:`Y1 DLC_ShorttendonMandible`,
    names_to = c("coord_knot", "dlc"),
    names_sep = " ",
    values_to = "value"
  ) |> 
  separate_wider_position(coord_knot, c(coord = 1, knot = 2), too_few = "align_start") |> 
